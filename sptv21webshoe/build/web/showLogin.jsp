...
<h2 class="my-2 w-100 d-flex justify-content-center">Введите имя пользователя и пароль </h2>
<div class="w-100 d-flex justify-content-center">
    <form action="login" method="POST" >
      <div class="card border-0 px-3" style="width: 20em;">
        <div class="form-group">
            <label for="login" class="form-label mt-2">Имя пользователя</label>
        ...
        <h4 class="w-100 text-center mt-3"><a href="showRegistration">Регистрация</a></h4>
      </div>
    </form>
</div>